  ...
  const swiperPrams = {
    ...
    return (<>
      ...
      {slides?.map((slideContent, index) => (
        ...
        <Button buttonText='좋아요'
        handleClickFunction={()=>{  handleSendLike(slideContent.props)  }}/>
        <Button buttonText='시러요'
        handleClickFunction={()=>{  handleSendDislike(slideContent.props) }}/>
          </div>
